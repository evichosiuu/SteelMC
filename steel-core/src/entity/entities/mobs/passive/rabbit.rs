//! Vanilla Rabbit entity implementation.
...
impl LivingEntity for RabbitEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_RABBIT_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_RABBIT_DEATH) }
...
impl Mob for RabbitEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_RABBIT_AMBIENT) }
