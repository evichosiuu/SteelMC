//! Vanilla Axolotl entity implementation.
...
impl LivingEntity for AxolotlEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_AXOLOTL_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_AXOLOTL_DEATH) }
...
impl Mob for AxolotlEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_AXOLOTL_IDLE_AIR) }
