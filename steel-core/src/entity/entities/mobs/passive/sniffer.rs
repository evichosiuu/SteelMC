//! Vanilla Sniffer entity implementation.
...
impl LivingEntity for SnifferEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SNIFFER_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SNIFFER_DEATH) }
...
impl Mob for SnifferEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SNIFFER_IDLE) }
