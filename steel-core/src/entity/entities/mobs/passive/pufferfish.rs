//! Vanilla Pufferfish entity implementation.
...
impl LivingEntity for PufferfishEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_PUFFER_FISH_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_PUFFER_FISH_DEATH) }
