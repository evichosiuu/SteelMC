//! Vanilla Salmon entity implementation.
...
impl LivingEntity for SalmonEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SALMON_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SALMON_DEATH) }
...
impl Mob for SalmonEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SALMON_AMBIENT) }
