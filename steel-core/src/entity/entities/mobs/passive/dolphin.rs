//! Vanilla Dolphin entity implementation.
...
impl LivingEntity for DolphinEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_DOLPHIN_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_DOLPHIN_DEATH) }
...
impl Mob for DolphinEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_DOLPHIN_AMBIENT) }
