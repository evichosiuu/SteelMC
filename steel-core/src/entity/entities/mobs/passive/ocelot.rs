//! Vanilla Ocelot entity implementation.
...
impl LivingEntity for OcelotEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_OCELOT_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_OCELOT_DEATH) }
...
impl Mob for OcelotEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_OCELOT_AMBIENT) }
