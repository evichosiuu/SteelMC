//! Vanilla TropicalFish entity implementation.
...
impl LivingEntity for TropicalFishEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_TROPICAL_FISH_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_TROPICAL_FISH_DEATH) }
...
impl Mob for TropicalFishEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_TROPICAL_FISH_AMBIENT) }
