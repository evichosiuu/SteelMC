//! Vanilla Turtle entity implementation.
...
impl LivingEntity for TurtleEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_TURTLE_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_TURTLE_DEATH) }
