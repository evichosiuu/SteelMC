//! Vanilla WanderingTrader entity implementation.
...
/// Vanilla WanderingTrader entity.
...
impl LivingEntity for WanderingTraderEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_WANDERING_TRADER_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_WANDERING_TRADER_DEATH) }
...
impl Mob for WanderingTraderEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_WANDERING_TRADER_AMBIENT) }
