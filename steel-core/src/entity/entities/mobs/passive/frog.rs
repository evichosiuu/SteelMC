//! Vanilla Frog entity implementation.
...
impl LivingEntity for FrogEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_FROG_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_FROG_DEATH) }
...
impl Mob for FrogEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_FROG_AMBIENT) }
