//! Vanilla Tadpole entity implementation.
...
impl LivingEntity for TadpoleEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_TADPOLE_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_TADPOLE_DEATH) }
