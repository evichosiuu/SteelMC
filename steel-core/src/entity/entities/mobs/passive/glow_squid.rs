//! Vanilla GlowSquid entity implementation.
...
impl LivingEntity for GlowSquidEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_GLOW_SQUID_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_GLOW_SQUID_DEATH) }
...
impl Mob for GlowSquidEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_GLOW_SQUID_AMBIENT) }
