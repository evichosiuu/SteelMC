//! Vanilla MushroomCow entity implementation.
...
impl LivingEntity for MushroomCowEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_COW_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_COW_DEATH) }
...
impl Mob for MushroomCowEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_COW_AMBIENT) }
