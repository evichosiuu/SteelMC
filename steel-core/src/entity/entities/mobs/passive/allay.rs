//! Vanilla Allay entity implementation.
...
impl AllayEntity {
    ...
    /// Reconstructs an Allay from saved NBT data.
    #[must_use]
...
impl Mob for AllayEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&sound_events::ENTITY_ALLAY_AMBIENT_WITHOUT_ITEM)
    }
