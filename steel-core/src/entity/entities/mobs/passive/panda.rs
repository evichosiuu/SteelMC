//! Vanilla Panda entity implementation.
...
impl LivingEntity for PandaEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_PANDA_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_PANDA_DEATH) }
...
impl Mob for PandaEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_PANDA_AMBIENT) }
