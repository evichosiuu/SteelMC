//! Vanilla Phantom entity implementation.
...
impl LivingEntity for PhantomEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_PHANTOM_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_PHANTOM_DEATH) }
...
impl Mob for PhantomEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_PHANTOM_AMBIENT) }
