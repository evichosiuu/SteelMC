//! Vanilla Vindicator entity implementation.
...
impl LivingEntity for VindicatorEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_VINDICATOR_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_VINDICATOR_DEATH) }
...
impl Mob for VindicatorEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_VINDICATOR_AMBIENT) }
