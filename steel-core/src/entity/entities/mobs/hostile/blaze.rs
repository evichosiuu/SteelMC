//! Vanilla Blaze entity implementation.
...
impl LivingEntity for BlazeEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_BLAZE_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_BLAZE_DEATH) }
...
impl Mob for BlazeEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_BLAZE_AMBIENT) }
