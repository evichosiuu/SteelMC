//! Vanilla WitherSkeleton entity implementation.
...
impl LivingEntity for WitherSkeletonEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_WITHER_SKELETON_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_WITHER_SKELETON_DEATH) }
...
impl Mob for WitherSkeletonEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_WITHER_SKELETON_AMBIENT) }
