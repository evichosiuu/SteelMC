//! Vanilla Warden entity implementation.
...
impl LivingEntity for WardenEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_WARDEN_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_WARDEN_DEATH) }
...
impl Mob for WardenEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_WARDEN_AMBIENT) }
