//! Vanilla ZombieVillager entity implementation.
...
impl ZombieVillagerEntity {
    ...
    fn new_with_base(base: EntityBase, entity_type: EntityTypeRef) -> Self {
        ...
        let mut entity_data = ZombieVillagerEntityData::new(&mut steel_utils::random::legacy_random::LegacyRandom::from_seed(rand::random()));
...
impl LivingEntity for ZombieVillagerEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_ZOMBIE_VILLAGER_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_ZOMBIE_VILLAGER_DEATH) }
...
impl Mob for ZombieVillagerEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_ZOMBIE_VILLAGER_AMBIENT) }
