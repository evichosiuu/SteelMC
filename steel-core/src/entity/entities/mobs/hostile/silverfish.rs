//! Vanilla Silverfish entity implementation.
...
impl LivingEntity for SilverfishEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SILVERFISH_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SILVERFISH_DEATH) }
...
impl Mob for SilverfishEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SILVERFISH_AMBIENT) }
