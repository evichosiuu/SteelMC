//! Vanilla MagmaCube entity implementation.
...
impl LivingEntity for MagmaCubeEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_MAGMA_CUBE_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_MAGMA_CUBE_DEATH) }
