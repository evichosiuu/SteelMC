//! Vanilla CopperGolem entity implementation.
...
impl LivingEntity for CopperGolemEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_IRON_GOLEM_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_IRON_GOLEM_DEATH) }
