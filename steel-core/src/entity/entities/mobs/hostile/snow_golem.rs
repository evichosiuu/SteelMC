//! Vanilla SnowGolem entity implementation.
...
impl LivingEntity for SnowGolemEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SNOW_GOLEM_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SNOW_GOLEM_DEATH) }
...
impl Mob for SnowGolemEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SNOW_GOLEM_AMBIENT) }
