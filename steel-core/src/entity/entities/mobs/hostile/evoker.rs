//! Vanilla Evoker entity implementation.
...
impl LivingEntity for EvokerEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_EVOKER_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_EVOKER_DEATH) }
...
impl Mob for EvokerEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_EVOKER_AMBIENT) }
