//! Vanilla Pillager entity implementation.
...
impl LivingEntity for PillagerEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_PILLAGER_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_PILLAGER_DEATH) }
...
impl Mob for PillagerEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_PILLAGER_AMBIENT) }
