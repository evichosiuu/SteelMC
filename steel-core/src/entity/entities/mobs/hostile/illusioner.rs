//! Vanilla Illusioner entity implementation.
...
impl LivingEntity for IllusionerEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_ILLUSIONER_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_ILLUSIONER_DEATH) }
...
impl Mob for IllusionerEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_ILLUSIONER_AMBIENT) }
