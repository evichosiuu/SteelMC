//! Vanilla Shulker entity implementation.
...
impl LivingEntity for ShulkerEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SHULKER_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SHULKER_DEATH) }
...
impl Mob for ShulkerEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SHULKER_AMBIENT) }
