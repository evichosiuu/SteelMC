//! Vanilla Breeze entity implementation.
...
impl LivingEntity for BreezeEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_BREEZE_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_BREEZE_DEATH) }
