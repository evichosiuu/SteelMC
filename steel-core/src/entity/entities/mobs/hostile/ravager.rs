//! Vanilla Ravager entity implementation.
...
impl LivingEntity for RavagerEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_RAVAGER_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_RAVAGER_DEATH) }
...
impl Mob for RavagerEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_RAVAGER_AMBIENT) }
