//! Vanilla Stray entity implementation.
...
impl LivingEntity for StrayEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_STRAY_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_STRAY_DEATH) }
...
impl Mob for StrayEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_STRAY_AMBIENT) }
