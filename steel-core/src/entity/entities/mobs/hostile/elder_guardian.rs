//! Vanilla ElderGuardian entity implementation.
...
/// Vanilla ElderGuardian entity.
pub struct ElderGuardianEntity {
    base: EntityBase,
    entity_type: EntityTypeRef,
    living_base: LivingEntityBase,
    mob_base: MobBase,
    entity_data: SyncMutex<ElderGuardianEntityData>,
}
...
impl LivingEntity for ElderGuardianEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_ELDER_GUARDIAN_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_ELDER_GUARDIAN_DEATH) }
...
impl Mob for ElderGuardianEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_ELDER_GUARDIAN_AMBIENT) }
