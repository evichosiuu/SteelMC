//! Vanilla Bogged entity implementation.
...
impl LivingEntity for BoggedEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SKELETON_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SKELETON_DEATH) }
...
impl Mob for BoggedEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_SKELETON_AMBIENT) }
