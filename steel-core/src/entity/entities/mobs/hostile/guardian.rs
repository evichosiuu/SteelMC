//! Vanilla Guardian entity implementation.
...
impl LivingEntity for GuardianEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_GUARDIAN_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_GUARDIAN_DEATH) }
...
impl Mob for GuardianEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_GUARDIAN_AMBIENT) }
