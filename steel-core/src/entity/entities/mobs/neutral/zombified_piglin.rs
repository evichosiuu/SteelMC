//! Vanilla ZombifiedPiglin entity implementation.
...
/// Vanilla ZombifiedPiglin entity.
...
impl LivingEntity for ZombifiedPiglinEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_ZOMBIFIED_PIGLIN_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_ZOMBIFIED_PIGLIN_DEATH) }
...
impl Mob for ZombifiedPiglinEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_ZOMBIFIED_PIGLIN_AMBIENT) }
