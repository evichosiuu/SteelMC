//! Vanilla Wolf entity implementation.
...
impl LivingEntity for WolfEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_WOLF_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_WOLF_DEATH) }
...
impl Mob for WolfEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_WOLF_AMBIENT) }
