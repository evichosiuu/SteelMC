//! Vanilla PolarBear entity implementation.
...
impl LivingEntity for PolarBearEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_POLAR_BEAR_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_POLAR_BEAR_DEATH) }
...
impl Mob for PolarBearEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_POLAR_BEAR_AMBIENT) }
