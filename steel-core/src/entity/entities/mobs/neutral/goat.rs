//! Vanilla Goat entity implementation.
...
impl LivingEntity for GoatEntity {
    ...
    fn hurt_sound(&self, _source: &DamageSource) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_GOAT_HURT) }
    fn death_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_GOAT_DEATH) }
...
impl Mob for GoatEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> { Some(&sound_events::ENTITY_GOAT_AMBIENT) }
