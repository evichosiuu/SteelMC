...
mod tests {
    ...
    fn dummy_factory_outcomes_keep_proto_and_full_stage_semantics() {
        ...
        let jukebox_pos = BlockPos::new(3, 4, 5);
        assert!(
            proto
                .set_block_state_for_generation(
                    ChunkStatus::Empty,
